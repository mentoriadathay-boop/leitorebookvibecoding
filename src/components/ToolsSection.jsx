  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: 'Bolt.new',
        emoji: '⚡',
        desc: 'Apps full-stack no navegador. Bom para prototipar UI rapidamente. Pior que Lovable e v0 em testes diretos (2025) — apps complexos não ficaram 100% funcionais. Melhor para iteração visual rápida e validações iniciais.',
        tag: 'Prototipagem',
        tagColor: 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400',
        url: 'https://bolt.new',
      },
      {
        name: 'v0.dev',
        emoji: '🎨',
        desc: 'Melhor qualidade visual do mercado — componentes React/Tailwind impecáveis a partir de texto ou imagem. Fraqueza: quase zero de backend. Não faz auth, banco ou lógica. Use em conjunto com Supabase para o full-stack.',
        tag: 'UI/Frontend',
        tagColor: 'bg-blue-100 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400',
        url: 'https://v0.dev',
        badge: 'top',
      ...
      },
      {
        ...
        emoji: '🔵',
        desc: 'IDE full-stack do Google no navegador (antigo Project IDX), lançado abr/2025. Suporta React, Flutter, Python, Go e mais. Agente de prototipagem no-code integrado. Profunda integração com Firebase/Supabase. Grátis. Fraco para bases de código grandes em produção.',
        tag: 'Google / Full-Stack',
        tagColor: 'bg-blue-100 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400',
      ...
      },
      {
        name: 'Stitch',
        emoji: '🧵',
        desc: 'Ferramenta do Google (Google I/O 2025) que gera UI completa e design system a partir de texto ou voz. Grátis (Google Labs). Ainda sem colaboração em equipe. Melhor para landing pages e protótipos de UI rápidos. Não gera lógica de negócio.',
        tag: 'Google / Voz para UI',
        tagColor: 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400',
      ...
      },
      {
        name: 'Tempo',
        emoji: '⏱️',
        desc: 'IDE visual para React — arrastar, soltar e editar código ao mesmo tempo. Gera 60-80% do frontend. Plugin Figma integrado, templates prontos (Stripe, Supabase, Clerk). Ideal para equipes com design + dev. Plano gratuito com 30 prompts/mês.',
        tag: 'React Visual',
      ...
      },
      {
        name: 'Webflow',
        emoji: '🌐',
        desc: 'Construtor visual maduro para sites de produto e marketing. Em 2025 ganhou IA que gera sites inteiros a partir de texto + integração GSAP para animações. Melhor que Framer em SEO e CMS complexo. Pior para apps com lógica intensa. $16-$156/mês.',
        tag: 'Sites de produto',
        tagColor: 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400',
      ...
      },
      {
        name: 'Bubble',
        emoji: '🫧',
        desc: 'A plataforma no-code mais poderosa para lógica complexa. Melhor que Lovable para fluxos de negócio elaborados (marketplaces, multi-tenant). Em 2025 lançou builder nativo para iOS/Android. Curva de aprendizado alta e custo pode escalar rápido (sistema de Workload Units).',
        tag: 'No-Code Avançado',
        tagColor: 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400',
        url: 'https://bubble.io',
      },
      {
        name: 'FlutterFlow',
        emoji: '📱',
        desc: 'Melhor plataforma no-code para apps mobile (iOS + Android). 200+ componentes prontos, integração nativa Firebase, colaboração em tempo real. Fraco para web. Atualização ago/2025 trouxe sugestões de design por IA. Plano gratuito disponível.',
      ...
      },
      {
        name: 'Dora AI',
        emoji: '🌀',
        desc: 'Gerador de sites com animações 3D a partir de prompts. Única no mercado para landing pages visualmente imersivas sem código. Ainda em beta, não é para SaaS ou apps complexos. Plano gratuito, pago a partir de $14/mês.',
        tag: 'Sites 3D',
      ...
      },
      {
        name: 'Framer',
        emoji: '🖼️',
        desc: 'Do design ao site publicado numa só plataforma. CMS, animações sem código, responsivo por padrão. Cresceu como alternativa ao Figma após alta de preços de 33% em 2025. Melhor para sites de produto e landing pages. Fraco para apps com lógica complexa.',
