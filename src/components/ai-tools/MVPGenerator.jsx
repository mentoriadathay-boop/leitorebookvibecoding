...
const prioColor = { must: 'bg-coral-100 text-coral-700', should: 'bg-stargold-100 text-stargold-700', could: 'bg-blue-100 text-blue-700' }
    ...
    <div className="space-y-6">
      ...
      {result && (
        <div className="space-y-4">
          {/* Header */}
          <div className="bg-white dark:bg-[#1A1A1A] rounded-2xl border border-gray-200 dark:border-gray-700 p-5">
            <h3 className="font-playfair text-xl font-bold text-[#3E1B4D] dark:text-magic-light">{result.nome_mvp}</h3>
              ...
              {result.prompts_para_construir?.map((p, i) => (
                <div key={i} className="flex items-start gap-2 bg-gray-50 dark:bg-[#111] rounded-lg p-3">
                  <div className="flex-1">
                    <p className="text-[10px] font-bold text-[#F5B942] mb-1">Prompt {i + 1}</p>
