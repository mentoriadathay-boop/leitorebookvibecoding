    ...
    <>
      <aside className="w-full h-full overflow-y-auto scrollbar-thin bg-[#FAFAFA] dark:bg-[#111] flex flex-col">
        ...
        <div className="p-3 border-b border-white/10">
          <p className="text-[10px] uppercase tracking-wider text-white/40 font-semibold mb-1.5">Ebook</p>
          ...
          <button
            ...
            className="text-[10px] text-[#C9A84C] mt-1.5 font-medium hover:underline"
          >
            Ver capa →
          </button>
        </div>
        ...
        <div className="p-3 border-b border-white/10">
          <p className="text-[11px] uppercase tracking-wider text-white/40 font-semibold">Sumário</p>
        </div>
          ...
          {chapterGroups.map(group => (
            <div key={group.label} className="mb-1">
              <button
                ...
                className="w-full flex items-center justify-between px-3 py-2 text-xs font-semibold text-white/40 hover:bg-white/10 transition-colors uppercase tracking-wide"
              >
                {group.label}
                ...
                return (
                  ...
                  >
                    ...
                    <span className="truncate leading-snug">
                      ...
                      <span className="text-[10px] text-white/35">p. {ch.page}</span>
                    </span>
                  </button>
                )
              })}
